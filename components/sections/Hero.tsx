...
export function Hero() {
  return (
    <section
      ...
      className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center gap-12 px-4 pt-24 pb-12 md:flex-row md:gap-16 md:px-8"
    >
      <motion.div
      ...
      >
        <Image
          ...
          alt="Akmaludien Ramadhan — AI Software Engineer"
          width={400}
          height={533}
          priority
